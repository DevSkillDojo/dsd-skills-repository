---
title: "I use the Zachman Framework to define process levels. Here's why (and how)"
date: "2021-09-07"
author: "Greg Fullard"
category: "Process Modelling"
description: "The levels of abstraction in the Zachman Framework are great for avoiding fuzzy definitions of business process levels."
image: "card_value_chain.png"
---

We often hear people speak about process "levels" using terms like "level 1", "level 2", or "level 5". 
This implies that there is some globally agreed standard that specifies the levels of details in business processes. 
...
* **Mid-level diagrams represent an "operational" view** which defines and identifies more granular activities and outcomes, including exceptions and alternative paths.
...
Each of the high-level functional areas would then be drilled-down into its own conceptual-level model.
...
To keep conceptual models clean, I try to keep fewer than 10 (ideally less than 6) processes on a single diagram. 
This means that I sometimes create drill-down diagrams of sections that form a cohesive unit. These drill-down diagrams help to break down the model into manageable chunks, but they still belong in the conceptual layer of abstraction.
...
At the logical level I use BPMN notation, which contains all the nitty-gritty details of the processes. This includes various aspects that 
...
The implementation level is always platform-dependent. It may include source code (for a custom dev project), or perhaps a Domain-Specific-Language (like that used in Robocorp), or perhaps some visual 
modelling approach (such as those used in many RPA tools).
