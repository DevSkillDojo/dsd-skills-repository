...
updated: "2020-10-01"
perspective: "TOOLS"
description: "Route 53 is a DNS web service that can be used for domain registration, DNS routing, and a range of related health checks."
---
## Identification:
- Fully Qualified Name: /tools/cloud-platforms/aws/aws-route53
...
https://www.youtube.com/watch?v=AAq-DDbFiIE (AWS re:Invent 2016: DNS Demystified: Amazon Route 53, featuring Warner Bros. (NET202))
https://www.youtube.com/watch?v=PVBC1gb78r8 (AWS re:Invent 2017: DNS Demystified: Global Traffic Management with Amazon Route 53 (NET302))
Handy DNS article: https://medium.com/@ayushkgupta007/demystifying-dns-3fb936940c76
