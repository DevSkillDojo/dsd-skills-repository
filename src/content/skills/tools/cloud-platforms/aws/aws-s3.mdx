...
---
## Identification:
- Fully Qualified Name: /tools/cloud-platforms/aws/aws-s3
...
Like most skills, X is not used in isolation, but with other skills in your toolbox. If you build proficiency in these complementary skills, you are likely to be more successful at using X in a real-world setting.
 ...
 - AWS Snowball Edge
 - AWS Snowmobile
 - AWS CloudTrail (For data event logging)
 - AWS Lambda (For Event Notifications)
 - AWS SNS (For Event Notifications)
 - AWS SQL (For Event Notifications)
